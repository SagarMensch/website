...
const NAV_LINKS = [
  { label: 'Shift', href: 'https://shift.sequelstring.com' },
  { label: 'Grid', href: 'https://grid.sequelstring.com' },
  { label: 'Orbit', href: 'https://orbit.sequelstring.com' },
  { label: 'Trust', href: 'https://trust.sequelstring.com' },
]
        ...
        <div className="max-w-7xl mx-auto h-full px-6 flex items-center justify-between">
          <a href="#" className="flex items-center gap-2.5">
            <div className="bg-white px-2 py-1.5 rounded-lg flex items-center justify-center">
              <img src="/SequelStrinAI_Logo.png" alt="SequelString AI" className="h-6 w-auto" />
            </div>
          </a>
